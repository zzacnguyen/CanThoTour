...
public class Config {
    public static final String URL_HOST = "http://192.168.1.7/doan3_canthotour/public/";
    ...
    public static final ArrayList<String> JSON_PLACE_INFO =
            new ArrayList<String>(Arrays.asList("tq_tendiemthamquan", "dd_diachi", "dd_sodienthoai", "dv_giathapnhat",
                    "dv_giacaonhat", "dv_giomocua", "dv_giodongcua", "dv_gioithieu", "dv_iddichvu"));
    ...
    public static final ArrayList<String> JSON_HOTEL_INFO =
            new ArrayList<String>(Arrays.asList("ks_tenkhachsan", "dd_diachi", "dd_sodienthoai", "dv_giathapnhat",
                    "dv_giacaonhat", "dv_giomocua", "dv_giodongcua", "dv_gioithieu", "dv_iddichvu", "ks_website"));
