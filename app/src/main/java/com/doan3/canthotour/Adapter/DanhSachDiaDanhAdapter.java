...
public class DanhSachDiaDanhAdapter extends RecyclerView.Adapter<DanhSachDiaDanhAdapter.ViewHolder> {
    ArrayList<DiaDanh> diaDanhs;
    Context context;

    public DanhSachDiaDanhAdapter(ArrayList<DiaDanh> diaDanhs, Context context) {
